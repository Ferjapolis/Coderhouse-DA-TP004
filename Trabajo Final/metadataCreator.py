...
class Metadata:
    ...
    def ReadXLSX(self, file_input, sheetname=None):
        """Cargar archivo de entrada en un diccionario de dataframes de pandas"""
        self.filename = file_input
        data = pd.read_excel(file_input, sheet_name=sheetname)
    ...
    def ExportReport(self, filename="metadatos"):
        """Serializar excel y guardar metadatos en un archivo"""
